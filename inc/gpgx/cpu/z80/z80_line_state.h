...
#ifndef __GPGX_CPU_Z80_Z80_LINE_STATE_H__
#define __GPGX_CPU_Z80_Z80_LINE_STATE_H__
...
enum LineState
{
  kClearLine = 0, /// Clear (a fired, held or pulsed) line.
  kAssertLine,    /// Assert an interrupt immediately.
  kHoldLine,      /// Hold interrupt line until acknowledged.
  kPulseLine      /// Pulse interrupt line for one instruction.
};

} // namespace gpgx::cpu::z80

#endif // #ifndef __GPGX_CPU_Z80_Z80_LINE_STATE_H__
